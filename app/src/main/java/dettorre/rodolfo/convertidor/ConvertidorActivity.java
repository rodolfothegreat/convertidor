...
implements OnClickListener , OnItemSelectedListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        fspinnerUnitType = findViewById(R.id.spinnerUnitType);
        ...
        fBtnConvert = findViewById(R.id.btnConvert);
        fEditValue = findViewById(R.id.editValue);
        ftextViewResult =  findViewById(R.id.textViewResult);
